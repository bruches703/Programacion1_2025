...
def get_int(mensaje: str, mensaje_error: str, minimo: int,
    ...
    return validate_number_int(numero, mensaje_error,
                                      minimo, maximo, 10)
...
def get_float(mensaje: str, mensaje_error: str, minimo: int,
    ...
    numero = validate_number_float(numero, "Error de ingreso, reingrese: ",
                                      minimo, maximo, 10)
    return numero
...
def get_string(mensaje: str, mensaje_error: str, longitud: int,
    ...
    return validate_length(cadena, mensaje_error, reintentos,
                                      longitud)
